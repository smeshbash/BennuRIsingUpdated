...
const newHeroContent = `<div className="max-w-6xl mx-auto relative z-10 pt-8 lg:pr-[350px]">
              <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                  {/* Logo Column */}
                  <div className="flex justify-center items-center relative flex-shrink-0 w-full lg:w-[45%]">
                     <div className="absolute w-[200px] h-[200px] bg-white/40 blur-[50px] rounded-full scale-75 -z-10 animate-pulse"></div>
                     <img src="/logo1.png" alt="Bennu Rising Logo" className="relative z-10 h-48 md:h-64 lg:h-auto lg:w-full lg:max-w-md mx-auto drop-shadow-2xl animate-float filter contrast-110 object-contain" referrerPolicy="no-referrer" />
                  </div>
